                ...
                @foreach($questions as $question)
                    <div class="card">
                        <div class="card-header px-3 py-4" id="heading{{ $question->id }}">
                            <a class="collapsed text-light" data-toggle="collapse" href="#collapse{{ $question->id }}" data-target="#collapse{{ $question->id }}" aria-expanded="false" aria-controls="collapse{{ $question->id }}">
                                {{ $question->name }}
                            </a>
                        </div>
